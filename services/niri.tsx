...
export default class Niri extends GObject.Object {
    ...
    public getMonitors(): Map<string, Monitor> {
    ...
    public readLineSocket(inputstream: Gio.DataInputStream, callback: (stream: Gio.DataInputStream | null, result: Gio.AsyncResult) => void) {
    ...
    public reconcileWorkspacesChanged(workspaces: Workspace[]) {
    ...
    public reconcileWorkspaceActivated(workspaceActivated: any) {
    ...
    public reconcileWorkspaceActiveWindowChanged(workspaceActiveWindowChanged: { workspace_id: number, active_window_id: number }) {
    ...
    public reconcileWindowsChanged(windows: Window[]) {
    ...
    public reconcileWindowOpenedOrChanged(window: Window) {
    ...
    public reconcileWindowClosed(windowClosed: { id: number }) {
        this.#state.windows.delete(windowClosed.id)
    }

    public reconcileWindowFocusChanged(windowFocusChanged: { id: number }) {
